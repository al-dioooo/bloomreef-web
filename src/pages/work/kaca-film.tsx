...
const data = {
    ...
    description: "Aplikasi untuk mempermudah CV. Agni sentral motor dalam mengelola pemesanan dan pemasangan yang terjadi di semua toko yang dimiliki perusahaan, dan merancang basis data untuk menyimpan data pemesanan dan pemasangan yang terjadi sehingga perusahaan dapat membentuk laporan secara digital.",
    url: {
        label: "guguskarangmekar.com/kacaFilmDev",
        href: "https://guguskarangmekar.com/kacaFilmDev"
    },
    photos: [
        {
            src: "/img/kaca-film-cover-design.png",
            alt: "Kaca Film Cover Design"
        }
    ]
}
    ...
    return (
        <div>
            ...
            <section ref={imageSectionContainer} className="pb-32">
                <div className="aspect-[32/9] overflow-hidden flex flex-col justify-center relative">
